    ...
    <div className="min-w-full grid-cols-1 grid-rows-3">
      ...
      <div className="mt-16" style={{ marginLeft: '500px', marginRight: '500px' }}>
        ...
        >
          ...
          modifications. If at any time you do not agree to these terms and conditions or do not wish to be bound by
          these terms and conditions, you may not access or use the site and immediately terminate your use of the
          services. Your Agreement to these Terms and Conditions for availing Service The Terms and Conditions (as may
          be amended from time to time, the “Agreement”) is a legal contract between you being, an individual customer,
          user, or beneficiary of this service of at least 18 years of age, and Wallora Personal Finance Management
          Services LLP (Wallora) having its registered office at 4, Broad Street, Kolkata - 700 019, India. All services
          are rendered by Wallora through its platform under the brand name ‘Wallora’. Hence all the rights, benefits,
          liabilities & obligations under the following terms & conditions shall accrue to the benefit of Wallora.
          (together with its subsidiaries and other affiliates, “us”, “We” or “Wallora”), regarding your use of our
          services which may be added from time to time (all such services are individually or collectively are referred
          as Service or Services as they case may be). Service can be used by you subject to your adherence with the
          terms and conditions set forth below including relevant policies. Wallora reserves the right, at its sole
          discretion, to revise, add, or delete portions of these terms and conditions any time without further notice.
        ...
        >
          ...
          from the Services. You represent and warrant that you have the right, authority, and capacity to enter into
          this Agreement and to abide by all of the terms and conditions of this Agreement. You shall not impersonate
        ...
        >
          ...
          downloading through the Site will be free of viruses, worms or other code that may be damaging. You are
        ...
        >
          ...
          notice. You agree that any termination of your access to the Services or any account you may have or portion
          thereof may be effected without prior notice, and you agree that Wallora will not be liable to you or any
          third party for any such termination. Any suspected fraudulent, abusive or illegal activity may be referred to
        ...
        >
          ...
          or non-pecuniary loss or damage of any nature whatsoever) arising out of or relating to (i) this agreement,
          (ii) the services, the site or any reference site, or (iii) your use or inability to use the services, the
          site (including any and all materials) or any reference sites, even if Wallora or a Wallora authorized
          representative has been advised of the possibility of such damages. In no event will Wallora or any of its
          contractors, directors, employees, agents, third party partners, licensors or suppliers’ total liability to
          you for all damages, liabilities, losses, and causes of action arising out of or relating to (i) this
          Agreement, (ii) the Services, (iii) your use or inability to use the Services or the Site (including any and
          all Materials) or any Reference Sites, or (iv) any other interactions with Wallora, however caused and whether
          arising in contract, tort including negligence, warranty or otherwise, exceed the amount paid by you, if any,
          for using the portion of the Services or the Site giving rise to the cause of action or One Thousand Rupees
          (Rs.1000), whichever is less. You acknowledge and agree that Wallora has offered its products and services,
          set its prices, and entered into this agreement in reliance upon the warranty disclaimers and the limitations
          of liability set forth herein, that the warranty disclaimers and the limitations of liability set forth herein
          reflect a reasonable and fair allocation of risk between you and Wallora, and that the warranty disclaimers
          and the limitations of liability set forth herein form an essential basis of the bargain between you and
          Wallora. Wallora would not be able to provide the services to you on an economically reasonable basis without
          these limitations. Applicable law may not allow the limitation or exclusion of liability or incidental or
          consequential damages, so the above limitations or exclusions may not apply to you. In such cases, Wallora’s
        ...
        >
          ...
          out of or related to your use or misuse of the Services or of the Site, any violation by you of this
          Agreement, or any breach of the representations, warranties, and covenants made by you herein. Wallora
          reserves the right, at your expense, to assume the exclusive defense and control of any matter for which you
          are required to indemnify Wallora, including rights to settle, and you agree to cooperate with Wallora’s
          defense and settlement of these claims. Wallora will use reasonable efforts to notify you of any claim,
        ...
        >
          ...
          No advice or information, whether oral or written, obtained by you from Wallora or through the services or the
          site will create any warranty not expressly stated herein. You expressly acknowledge that as used in this
          section, the term “Wallora” includes Wallora’s officers, directors, employees, shareholders, agents,
          licensors, subcontractors and affiliated companies. You acknowledge that Wallora is a reseller of Mobile
          recharges and is not liable for any 3rd party (telcos & suppliers) obligations due to rates, quality, and all
          other instances, whether to any such telco’s subscribers or otherwise. You expressly agree that use of the
          services and the site is at your sole risk. It is your responsibility to evaluate the accuracy, completeness
          and usefulness of all opinions, advice, services, merchandise and other information provided through the site
          or on the internet generally. We do not warrant that the service will be uninterrupted or error-free or that
          defects in the site will be corrected. The services and the site and any data, information, third party
          software, reference sites, services, or software made available in conjunction with or through the services
          and the site are provided on an “as is” and “as available,” “with all faults” basis and without warranties or
          representations of any kind either express or implied. Wallora, and its third party suppliers, licensors, and
          partners do not warrant that the data, Wallora software, functions, or any other information offered on or
          through the services, the site or any reference sites will be uninterrupted, or free of errors, viruses or
          other harmful components and do not warrant that any of the foregoing will be corrected. Wallora and its third
          ...
          information, materials, or data through the services, the site or any reference sites at your own discretion
          and risk and that you will be solely responsible for any damage to your property (including your computer
          system and device) or loss of data that results from the download or use of such material or data. We do not
          authorize anyone to make any warranty on our behalf and you should not rely on any such statement. This
          paragraph shall survive termination of this agreement. In no event will Wallora be liable for any incidental,
        ...
        >
          ...
          “Materials”) are protected by Indian copyright, trade dress, patent, and trademark laws, international
          conventions, and all other relevant intellectual property and proprietary rights, and applicable laws. As
          between you and Wallora, all Materials, trademarks, service marks, and trade names contained on the Site are
          the property of Wallora and/or third party licensors or suppliers. You agree not to remove, obscure, or alter
          Wallora or any third party’s copyright, patent, trademark, or other proprietary rights notices affixed to or
          contained within or accessed in conjunction with or through the Services. Except as expressly authorized by
          Wallora, you agree not to sell, license, distribute, copy, modify, publicly perform or display, transmit,
          publish, edit, adapt, create derivative works from, or otherwise make unauthorized use of the Materials.
          Wallora reserves all rights not expressly granted in this Agreement. If you have comments regarding the
          Services and the Site or ideas on how to improve it, please contact customer service. Please note that by
          doing so, you hereby irrevocably assign to Wallora, and shall assign to Wallora, all right, title and interest
          in and to all ideas and suggestions and any and all worldwide intellectual property rights associated
        ...
        >
          ...
          immediately on a going-forward basis with respect to payment transactions initiated after the posting date. If
          you do not agree with any such modification, your sole and exclusive remedy is to terminate your use of the
        ...
        >
          ...
          other party. The arbitration shall be conducted in Bangalore, India and judgment on the arbitration award may
          be entered in any court having jurisdiction thereof. Either you or We may seek any interim or preliminary
          relief from a court of competent jurisdiction in Bangalore, India, necessary to protect the rights or the
          property of you or Wallora (or its agents, suppliers, and subcontractors), pending the completion of
          arbitration. Any arbitration shall be confidential, and neither you nor We may disclose the existence, content
          or results of any arbitration, except as may be required by law or for purposes of the arbitration award. All
          administrative fees and expenses of arbitration will be divided equally between you and us. In all
        ...
        >
          ...
          perform or otherwise use the Site, the Platform or any of the IP Rights, or attempt to reverse engineer,
          decompile, disassemble, or derive the source code for the Platform or use the Platform or Site to create a
        ...
        >
          ...
          email address/mobile number that as per our records, or when We post the electronic communication on the
          Wallora Site. The requirements for such electronic transactions and communications following: you must have
          access to the Internet, mobile web, applications and a valid e-mail address. You can withdraw your consent at
          any time by contacting us, but We reserve the right to terminate your account upon such withdrawal. Withdrawal
          of your consent will not affect the legal validity and enforceability of any notice, statement or disclosure
        ...
        >
          ...
          contemporaneous undertakings and agreements between the parties, whether written or oral, with respect to that
          subject matter. Should any provision of these Terms be deemed unenforceable or invalid, the other provisions
          of these Terms shall remain in full force and effect. You cannot assign the Terms or delegate your obligations
          under these Terms without the express written consent of Wallora. The prevailing party in any action relating
          to these Terms shall be entitled to recover its reasonable legal fees, costs and disbursements incurred in
